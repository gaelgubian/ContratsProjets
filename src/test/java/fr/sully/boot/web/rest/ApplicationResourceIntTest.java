...
import fr.sully.boot.service.ApplicationService;
...
public class ApplicationResourceIntTest {
    ...
    private static final Langage DEFAULT_LANGAGE_PRINCIPAL = Langage.JAVA;
    private static final Langage UPDATED_LANGAGE_PRINCIPAL = Langage.JAVASCRIPT;
    ...
    public static Application createEntity(EntityManager em) {
        Application application = new Application()
            ...
            .langagePrincipal(DEFAULT_LANGAGE_PRINCIPAL)
            .image(DEFAULT_IMAGE)
    ...
    public void createApplication() throws Exception {
        ...
        assertThat(testApplication.getNomCourt()).isEqualTo(DEFAULT_NOM_COURT);
        assertThat(testApplication.getLangagePrincipal()).isEqualTo(DEFAULT_LANGAGE_PRINCIPAL);
        assertThat(testApplication.getImage()).isEqualTo(DEFAULT_IMAGE);
        assertThat(testApplication.getImageContentType()).isEqualTo(DEFAULT_IMAGE_CONTENT_TYPE);
    }
    ...
    public void getAllApplications() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].langagePrincipal").value(hasItem(DEFAULT_LANGAGE_PRINCIPAL.toString())))
    ...
    public void getApplication() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications/{id}", application.getId()))
            ...
            .andExpect(jsonPath("$.langagePrincipal").value(DEFAULT_LANGAGE_PRINCIPAL.toString()))
    ...
    public void updateApplication() throws Exception {
        ...
        updatedApplication
            ...
            .langagePrincipal(UPDATED_LANGAGE_PRINCIPAL)
            .image(UPDATED_IMAGE)
        ...
        assertThat(testApplication.getNomCourt()).isEqualTo(UPDATED_NOM_COURT);
        assertThat(testApplication.getLangagePrincipal()).isEqualTo(UPDATED_LANGAGE_PRINCIPAL);
        assertThat(testApplication.getImage()).isEqualTo(UPDATED_IMAGE);
        assertThat(testApplication.getImageContentType()).isEqualTo(UPDATED_IMAGE_CONTENT_TYPE);
    }
