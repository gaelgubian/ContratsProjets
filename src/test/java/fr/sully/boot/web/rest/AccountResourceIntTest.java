...
import fr.sully.boot.config.Constants;
import fr.sully.boot.SullyBootApp;
import fr.sully.boot.domain.Authority;
import fr.sully.boot.domain.User;
import fr.sully.boot.repository.AuthorityRepository;
import fr.sully.boot.repository.UserRepository;
import fr.sully.boot.security.AuthoritiesConstants;
import fr.sully.boot.service.MailService;
import fr.sully.boot.service.dto.UserDTO;
import fr.sully.boot.web.rest.errors.ExceptionTranslator;
import fr.sully.boot.web.rest.vm.KeyAndPasswordVM;
import fr.sully.boot.web.rest.vm.ManagedUserVM;
import fr.sully.boot.service.UserService;
