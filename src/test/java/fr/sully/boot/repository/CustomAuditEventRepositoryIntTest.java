...
import fr.sully.boot.config.audit.AuditEventConverter;
import fr.sully.boot.domain.PersistentAuditEvent;
...
import static fr.sully.boot.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
